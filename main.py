...
def PG_original2(data, output):
    ...
    results['total train execution time'] = train_execution_time_total
    results['total test execution time'] = test_execution_time_total
...
if __name__ == '__main__':
    ...
    candidate_selection("./training_data/JOB/", True,
                        "./checkpoints/JOB_alternating_new_3k_10ep_1step/", "cuda:2", 30,
                        f"selected_plans_hybrid.json")
    best_plan_prediction2("./training_data/JOB/", True,
                          "./checkpoints/JOB_alternating_new_3k_10ep_1step/", "cuda:2",
                          f"selected_plans_hybrid.json", f"./results/JOB/RankPQO_hybrid.txt")
    #for k in [40, 50]:
